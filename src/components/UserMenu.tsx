...
const UserMenu = () => {
  ...
  return (
    <>
     <div onClick={() => setMenuOpen(true)} className={"absolute  w-16 h-16  lg:top-24 top-32 right-0 flex flex-row justify-center p-2 items-center cursor-pointer"}>
    ...
    <div className={`h-screen w-96 bg-ecoWhite fixed top-0 right-[-1000px] flex flex-col p-2 items-center gap-3 ${menuOpen == 'initial' ? '' : menuOpen ? 'lateralMenuEntrance' : 'lateralMenuExit'}`}>
